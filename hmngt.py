...
def searchCustomer():
    ...
    if myConnection:
        ...
        print("\nSomthing Went Wrong ,Please Try Again !")
        print("""**************MSS PUBLIC SCHOOL **********************
                 ***************HOTEL MANAGEMENT SYSTEM *************************
                 *****************CROWN PLAZA MIAMI *****************************
                 #******* Designed and Maintained By: ***************************
                 #******* HARI SANKAR - CLASS XII A - ROLL NO - 20[ 2023-2024 ]****
                 #******* SAVINAY - CLASS XII A - ROLL NO - 28 [ 2023-2024 ]****
                 #******* HUSSAIN - CLASS XII A - ROLL NO - 19 [ 2023-2024 ]****""")
